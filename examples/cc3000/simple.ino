...
void setup() {
  ...
  plotly.username = "yourUsername"; // your plotly username -- sign up at https://plot.ly/ssu or feel free to use this public account. password of the account is "password"
  plotly.api_key = "yourApiKey"; // "public_arduino"'s api_key -- char api_key[10]
...
void loop() { 
  ...
  plotly.post(2, 20); // log second point on trace 0 with x=1, y=15
